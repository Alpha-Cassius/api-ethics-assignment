## Part 1: Content for your `answers.md` file
...
### Violation 2: Lack of Rate Limiting and Data Minimization
**Problem:** The script aggressively loops through 100 pages without any delay (`time.sleep`), which can overwhelm the server (denial of service). Furthermore, it saves *all* raw records—including PII—permanently to the database before cleaning them, violating "privacy by design" principles.
...
# Clean the data BEFORE permanent storage
cleaned_data = anonymize_patient_records(records)
